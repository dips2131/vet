        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              ...
              <div className="d-flex flex-column flex-md-row align-items-center flex-wrap justify-content-between">
                  ...
                  <div className="wrapper d-none d-lg-flex  align-items-center my-2">
                    ...
                    <button type="button" className="btn btn-light btn-fw ms-4"><i className="ti-lock"></i>Private</button>
                  </div>
